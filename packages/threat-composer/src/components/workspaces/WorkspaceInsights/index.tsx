  ...
  const [items, setItems] = useState<BoardProps.Item<ItemType>[]>([
    {
      ...
      rowSpan: 3,
      columnSpan: 6,
      data: { title: 'Risk summary', content: <Overview {...props}/> },
    },
    {
      id: 'risk-prioritization',
      rowSpan: 5,
      columnSpan: 2,
      data: { title: 'Risk prioritization', content: <ThreatPrioritization {...props}/> },
    },
    {
      id: 'risk-status',
      rowSpan: 5,
      columnSpan: 2,
      data: { title: 'Risk status', content: <ThreatStatus {...props}/> },
    },
    {
      id: 'stride-allocation',
      rowSpan: 5,
      columnSpan: 2,
      data: { title: 'Risk category distribution', content: <STRIDEAllocation {...props}/> },
    },
    {
      id: 'risk-grammer',
      rowSpan: 5,
      columnSpan: 2,
      data: { title: 'Risk grammar distribution', content: <ThreatGrammar {...props}/> },
    },
    {
