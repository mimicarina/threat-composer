...
import threatStatementElements from '../../../../../assets/risk-statement-elements.png';
import styles from '../../styles';
import InfoModalBase from '../InfoModalBase';

const InfoModalSelector: FC = () => {
  return (<InfoModalBase>
    <p>A useful risk statement considers <span css={css(styles.contentHighlight)}>risk source</span>,{' '}
      <span css={css(styles.contentHighlight)}>prerequisites</span>,{' '}
      <span css={css(styles.contentHighlight)}>risk action</span>,{' '}
      <span css={css(styles.contentHighlight)}>risk impact</span>,{' '}
      <span css={css(styles.contentHighlight)}>impacted goal</span>{' '}
      and <span css={css(styles.contentHighlight)}>impacted assets</span>.</p>
    <p>This tool empowers you to compose useful risk statements by providing examples and suggestions
