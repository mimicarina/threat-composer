    ...
    <div css={css(styles.featureSets)}>
      <Grid gridDefinition={[
        ...
        <div css={[css(styles.featureSet), css(styles.contentBaseText)]}>
          ...
          <div>Renders <span css={css(styles.contentHighlight)}>structured risk statements</span> based on user input</div>
        </div>
        <div css={[css(styles.featureSet), css(styles.contentBaseText)]}>
          ...
          <div>
            <span css={css(styles.contentHighlight)}>
              Adaptive risk statement structure
        ...
        <div css={[css(styles.featureSet), css(styles.contentBaseText)]}>
          ...
          <div>Complete risk statement <span css={css(styles.contentHighlight)}>examples to aid contextual brainstorming</span> and re-use</div>
        </div>
      </Grid>
    </div>
  </InfoModalBase>);
